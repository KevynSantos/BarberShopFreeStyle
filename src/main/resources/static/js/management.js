...
var rankingEmployee = function(idUser)
{
	...
	let fileUrl = window.location.origin+"/us/getRankingByUser?idUser="+idUser;
...
{
	$.ajax({
	     url : "/request/getTypeProfileByIdRequest",
	     type : 'GET',
	     data : {
	    	 idRequest : itemId
	     },
...
function Management(){
	...
	{
		$.ajax({
		     url : "/service/getStatusOfDiscount",
		     type : 'GET',
		     data : {
		     },
		     async: false,
	...
	var updateStatusDiscount = function()
	{
		$(".liga-desliga__botao").click(function(){
			...
			$.ajax({
			     url : "/service/enableOrDisableDiscount?enableOrDisable="+enableOrDisable.toString(),
			     type : 'POST',
			     async: false,
			     beforeSend : function(){
			          //none
	...
	var updateValueDiscount = function()
	{
		$(".btn_update_value_discount").click(function(){
			...
			$.ajax({
			     url : "/service/updateValueDiscount?newValue="+value.toString(),
			     type : 'POST',
			     async: false,
			     beforeSend : function(){
			          //none
